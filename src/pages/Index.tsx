...
import { Upload, Activity, Heart, Brain, TrendingUp, Clock, Zap } from "lucide-react";
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 animate-fade-in">
              Decode Your Fitness Data
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-blue-100 max-w-3xl mx-auto">
              Overwhelmed by fitness metrics? Upload your app screenshot and get 
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Take a screenshot from any fitness app and upload it
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  AI processes your metrics and identifies patterns
                </p>
              </div>
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold mb-2">3. Insights</h3>
                <p className="text-gray-600">
                  Get professional recommendations and actionable advice
                </p>
              </div>
            </div>
          </CardContent>
