    ...
    <div className="vault-display space-y-4">
      ...
      <div className="space-y-2">
        <div className="flex items-baseline justify-between">
          <span className="text-xs text-muted-foreground uppercase">Капитал под угрозой</span>
        ...
        <div className="flex justify-between text-xs text-muted-foreground">
          <span>Депозит: ${vault.depositAmount.toFixed(2)}</span>
          <span className="text-destructive">Налог: ${vault.weaknessTaxes.toFixed(2)}</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4 pt-2 border-t border-border">
        <div className="text-center">
          ...
          <div className="text-xs text-muted-foreground uppercase">Серия</div>
        </div>
        <div className="text-center">
        ...
        <div className="text-center">
          ...
          <div className="text-xs text-muted-foreground uppercase">Уровень</div>
        </div>
      </div>
      ...
      {percentRemaining < 30 && (
        <div className="flex items-center gap-2 p-2 bg-destructive/10 border border-destructive/30">
          ...
          <span className="text-xs text-destructive uppercase">
            Критично: истощение капитала неизбежно
          </span>
        </div>
      )}
    </div>
