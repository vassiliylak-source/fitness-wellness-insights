    ...
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-gray-600">
          Our AI understands all major fitness metrics and provides actionable insights
        </p>
      </div>
      ...
      <Card className="bg-gradient-to-r from-gray-50 to-blue-50 border-gray-200">
        ...
        <CardContent>
          <div className="flex flex-wrap justify-center gap-4">
            {[
              "Apple Health", "Strava", "Garmin Connect", "Fitbit", 
              "MyFitnessPal", "Nike Run Club", "Polar Flow", "Suunto",
              "Oura Ring", "Whoop", "Coros", "Wahoo"
            ].map((app, index) => (
